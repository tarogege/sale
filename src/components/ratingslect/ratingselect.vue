<template>
  <div class="ratingselect">
    <div class="items">
      <a @click='select($event,0)' class="all" :class="{'active':selectType === 0}"><span>{{catology[0]}}</span><span
        class="count">{{ratings.length}}</span></a>
      <a @click="select($event,1)" class="positive"
         :class="{'active':selectType === 1}"><span>{{catology[1]}}</span><span class="count">{{myfilter(0)}}</span></a>
      <a @click="select($event,2)" class="negative" :class="{'active':selectType === 2}">{{catology[2]}}<span
        class="count">{{myfilter(1)}}</span></a>
    </div>
